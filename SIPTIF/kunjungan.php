            ...
            <div class="footer-content">
                ...
                <div class="footer-section">
                    ...
                    <ul class="social-links">
                        <li><a href="https://www.facebook.com/polibatamofficial/?locale=id_ID"><i class="fab fa-facebook-f"></i> Facebook</a></li>
                        <li><a href="https://x.com/polibatam_"><i class="fab fa-twitter"></i> Twitter</a></li>
                        <li><a href="https://www.instagram.com/polibatamofficial/"><i class="fab fa-instagram"></i> Instagram</a></li>
                        <li><a href="https://www.youtube.com/@PolibatamTV"><i class="fab fa-youtube"></i> YouTube</a></li>
                    </ul>
                </div>
                </div>
            </div>
